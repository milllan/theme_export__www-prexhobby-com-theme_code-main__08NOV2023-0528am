(function (factory) {
  ...
  var CollectionSection = /*#__PURE__*/function () {
    function CollectionSection(element) {
      ...
      console.log("jhjkhjkhk");
      console.log(this.element.getAttribute('data-section-settings'));
      if ($("body").hasClass("template-search")) {
        console.log("in don");
        var fixwala = '{"sectionId": "template--16055540678836__main", "filterPosition": "sidebar" }';
        this.settings = JSON.parse(fixwala);
      }else{
        console.log("nono");
          ...
          fetch(currentUrl.toString(), {
            ...
            response.text().then(function (content) {
              ...
              var collectionFiltersDrawer = _this4.element.querySelector('#collection-filters-drawer-form'),
                  collectionFiltersDrawer2 = _this4.element.querySelector('#collection-filters-drawer-form-2'),
              ...
              if (collectionFiltersDrawer2) {
                var newDrawerContent2 = tempElement.querySelector('#collection-filters-drawer-form-2');
                Array.from(collectionFiltersDrawer2.querySelectorAll('.Collapsible')).forEach(function (collapsible) {
                  var newCollapsible = newDrawerContent2.querySelector("[data-filter-index=\"".concat(collapsible.getAttribute('data-filter-index'), "\"]"));
                ...
                collectionFiltersDrawer2.innerHTML = newDrawerContent2.innerHTML;
                new ProductItemColorSwatch(_this4.element.querySelector('.ProductList'));
              }
              ...
              // ADD OPTION FILTER
              // document.querySelectorAll('.Collapsible--dropdown .Linklist__Checkbox').forEach(form => {
              //   if(form){
              //     form.addEventListener('click', e => {
              //       var el = e.target;
              //       var tagName = el.getAttribute('filter-label');
              //       var tagValue = el.getAttribute('data-value');
              //       var fakeTag = '<div style="width: 10px;"></div><span>' + tagValue + '</span>';
              //       var buttonTag = document.querySelectorAll('.Collapsible__Button-special[data-filter-name="' + tagName + '"]');
              //       if (form.hasAttribute("checked")) {
              //         $(buttonTag).remove(fakeTag);
              //       } else {
              //         $(buttonTag).append(fakeTag);
              //       }
              //     });
              //   }
              // });
